...
from python.libs.pconv_hybrid_model import PConvUnet
from python.libs.flood_fill import find_regions, expand_bounding
...
class Decensor():
    ...
    def decensor_all_images_in_folder(self):
        ...
        for file_name in file_names:
            ...
            if os.path.isfile(color_file_path) and os.path.splitext(color_file_path)[1] == ".png":
                print(
                    "--------------------------------------------------------------------------")
                print("Decensoring the image {color_file_path}".format(
    ...
    def decensor_image(self, ori, colored):
        ...
        for region_counter, region in enumerate(regions, 1):
            ...
            print("{region_counter} out of {region_count} regions decensored.".format(
        ...
        save_path = os.path.join(
            self.args.decensor_output_path, str(time.time()) + ".png")
